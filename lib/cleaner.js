...
const cleanOldJobs = async ({ completedMaxAgeHours, failedMaxAgeHours, pendingMaxAgeHours } = {}) => {
    ...
    const pendingToDelete = pendingMaxAgeHours ? jobs.filter(j => j.pod && j.pod.unschedulable && j.ageHours > pendingMaxAgeHours) : [];
